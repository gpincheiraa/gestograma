...
if(isLeap) {
	...
	xmlhttp.open("GET","http://www.portalmama.com/semanas_gestograma.php?semana="+weekOfPregnancy,true);
	xmlhttp.send();
...
//alert(_week);
	...
	xmlhttp.open("GET","http://www.portalmama.com/semanas_gestograma.php?semana="+_week,true);
	xmlhttp.send();
}	
